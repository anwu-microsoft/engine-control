###########################################################################
## Makefile generated for Simulink model 'engineclosed'. 
## 
## Makefile     : engineclosed.mk
## Generated on : Thu Jun 06 13:30:38 2019
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/engineclosed.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/sun9k/Documents/engcontrolCompiled
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
...
COMPILER_COMMAND_FILE     = engineclosed_comp.rsp
CMD_FILE                  = engineclosed.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/engineclosed.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/engineclosed_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=engineclosed -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/engineclosed_grt_rtw/engineclosed.c $(START_DIR)/engineclosed_grt_rtw/engineclosed_data.c $(START_DIR)/engineclosed_grt_rtw/rtGetInf.c $(START_DIR)/engineclosed_grt_rtw/rtGetNaN.c $(START_DIR)/engineclosed_grt_rtw/rt_nonfinite.c $(START_DIR)/engineclosed_grt_rtw/rt_zcfcn.c rt_sim.c $(MATLAB_ROOT)/rtw/c/grt/classic_main.c
...
OBJS = rt_logging.obj engineclosed.obj engineclosed_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_zcfcn.obj rt_sim.obj classic_main.obj
...
%.obj : $(START_DIR)/engineclosed_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/engineclosed_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
